...
// For each hour of the day planner.
function initPage() {
  ...
  var init11 = JSON.parse(localStorage.getItem("09:00 pm"))
  sevenPm.val(init11);
} 
...
$(document).ready(function(){
  ...
  // The button for the day planner to save inputs (aka save to Local Storage).
